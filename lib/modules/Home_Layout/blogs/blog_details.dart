...
import 'blog_det.dart';

class BolgDetailsScreen extends StatefulWidget {
  const BolgDetailsScreen({Key? key}) : super(key: key);

  @override
  State<BolgDetailsScreen> createState() => _BolgDetailsScreenState();
}

class _BolgDetailsScreenState extends State<BolgDetailsScreen> {
  @override
  Widget build(BuildContext context) {
    return BolgDetails(
      description:
       ...
       ,productImage: 'assets/Rectangle 15 (1).png',way: '5 Tips to treat plants',
       );
